...
public class userProfile extends AppCompatActivity implements ontaskComplet {
    ...
    TextView nameENG,emailENG,companyIdT, companyName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        companyIdT = (TextView) findViewById(R.id.companyId);
                        ...
                        public void onResponse(JSONArray jsonArray) {
                            ...
                            if(jsonArray.length()>0){
                                try {
                                    ...
                                    String companyId1 = jsonObject.getString("companyId");
                                  ...
                                  //  companyIdT.setText("Company ID: "+companyId1);
                                    companyName.setText(companyId1+", "+companyName1);
                                } catch (Exception ee){
                                    Toast.makeText(getApplicationContext(),ee.getLocalizedMessage(),Toast.LENGTH_LONG).show();
                                }
